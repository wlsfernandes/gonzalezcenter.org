...
$lang = array(
    ...
    'website_name' => 'Justo & Catherine Gonzalez Resource Center',
    ...
    'justo_legacy_1' => 'Dr. Justo L. Gonzalez is a distinguished theologian, historian, and educator, particularly known for his contributions to Hispanic theology. Born and raised in Havana, Cuba, Gonzalez was ordained as a minister in the Methodist church in 1957. He then earned his Ph.D. in Historical Theology from Yale University in 1961, becoming the youngest person to do so at the time.',
    'justo_legacy_2' => 'Throughout his career, Gonzalez has taught at various theological institutions, including the Evangelical Seminary of Puerto Rico and Candler School of Theology at Emory University. He has written over 150 books, with notable works such as "A History of Christian Thought" and "The History of Christianity," which have been translated into several languages.',
    'justo_legacy_3' => 'Dr. Gonzalez has been instrumental in advancing Hispanic theological education. He helped found the Hispanic Theological Initiative, the Hispanic Summer Program, and the Association for Hispanic Theological Education (AETH). His commitment to education is further reflected in the Justo and Catherine Gonzalez Resource Center, established in 2011 to support Latino ministries.',
    'justo_legacy_4' => 'Even after retiring from full-time teaching, Gonzalez continues to write, lecture, and mentor young theologians. He has received numerous honors, including four honorary doctorates and the Distinguished Service Medal from the Association of Theological Schools.',
    'justo_legacy_5' => 'Gonzalez’s work has significantly shaped Latino/a biblical hermeneutics and constructive theology, advocating for the recognition of the contextual nature of theology and its enrichment through diverse cultural perspectives.',
    'degrees' => array(
        'bachelor_of_arts' => '<strong>Bachelor of Arts (B.A.):</strong> Earned his undergraduate degree in theology from the University of Havana in Cuba.',
        'bachelor_of_divinity' => '<strong>Bachelor of Divinity (B.D.):</strong> Gonzalez earned his B.D. from Union Theological Seminary in New York.',
        'phd_historical_theology' => '<strong>Ph.D. in Historical Theology:</strong> Earned his Ph.D. from Yale University in 1970, becoming the youngest person to do so at the time.',
        'doctor_of_ministry' => '<strong>Doctor of Ministry (D.Min.):</strong> Also holds a Doctor of Ministry, emphasizing the practical application of theology in ministerial contexts.',
        'honorary_doctorates' => '<strong>Honorary Doctorates:</strong> Dr. Gonzalez has received multiple honorary doctorates from various institutions in recognition of his contributions to theology and education, though the specific institutions and degrees vary.',
    ),
    'achievements' => array(
        'first_latino_phd' => '<strong>First Latino to Obtain a Ph.D. from Yale University:</strong> Dr. Gonzalez became the youngest person and the first Latino to graduate with a Ph.D. in Historical Theology from Yale in 1970.',
        'ordained_minister' => '<strong>Ordained Minister:</strong> Was ordained as a minister in the Methodist Church in 1957, beginning his long commitment to ministry and theological education.',
        'prolific_author' => '<strong>Prolific Author:</strong> Dr. Gonzalez has written over 150 books on theology, history, and ministry, significantly contributing to the fields of Hispanic and Latino/a theology.',
        'advocate_hispanic_education' => '<strong>Advocate for Hispanic Theological Education:</strong> He has been instrumental in promoting and developing theological education for Hispanic communities, helping to establish programs that address their unique cultural contexts.',
        'educator_renowned_institutions' => '<strong>Educator at Renowned Institutions:</strong> Dr. Gonzalez has taught at various prestigious theological institutions, including Candler School of Theology at Emory University and the Interdenominational Theological Center in Atlanta.',
        'international_speaker' => '<strong>International Speaker and Lecturer:</strong> Dr. Gonzalez has lectured worldwide, sharing his insights on Hispanic theology, church history, and the intersection of faith and culture.',
        'member_american_academy' => '<strong>Member of the American Academy of Arts and Sciences:</strong> His academic contributions have earned him a place in this prestigious organization, recognizing his influence in the humanities.',
        'founder_hispanic_initiative' => '<strong>Founder of the Hispanic Theological Initiative:</strong> Co-founded this initiative to enhance training and support for Hispanic scholars in theological education.',
    ),
    ...
    'join_us' => 'Join Us',
    'catherine_gonzalez_profile' => 'Catherine González has made significant contributions to the field of theology and the study of Hispanic religious traditions. As a prominent scholar and educator, her work has been instrumental in advancing the understanding of theological issues within Latino communities. Through her research, writings, and teachings, Gonzalez has addressed themes such as the intersection of gender, culture, and faith, and has highlighted the role of women in shaping theological discourse.',
    'catherine_gonzalez_contributions' => 'Gonzalez`s scholarship has been pivotal in exploring how cultural and gender perspectives influence theological thought and practice. Her commitment to fostering a more inclusive and diverse theological environment has helped to elevate the voices of marginalized groups within Christianity. By focusing on the experiences and contributions of Hispanic women in theology, she has expanded the narrative and enriched the academic dialogue surrounding these crucial issues.',
    'catherine_gonzalez_impact' => 'Through her educational efforts and mentorship, Catherine Gonzalez continues to inspire and support the next generation of theologians, encouraging them to engage with and contribute to the rich tapestry of Hispanic theology. Her dedication to expanding theological perspectives and promoting social justice has had a lasting impact on both the academic community and the broader church.',
    'catherine_gonzalez_achievements' => array(
        'pioneering_research' => '<strong>Pioneering Research in Hispanic Theology:</strong> Gonzalez has conducted innovative research exploring the intersections of gender, culture, and faith within the context of Hispanic religious traditions. Her work has been pivotal in advancing the understanding of these issues and their impact on theological discourse.',
        'influential_publications' => '<strong>Influential Publications:</strong> She has written several significant works that have contributed to the academic and theological community. Her publications often address cultural identity and the role of women in theology, providing valuable perspectives and fostering a deeper understanding of these important issues.',
        'advancing_gender_inclusivity' => '<strong>Advancing Gender Inclusivity:</strong> Gonzalez has been a prominent advocate for including female voices and perspectives in theological studies. Her efforts have helped highlight and address gender disparities within the field, promoting a more inclusive and equitable academic environment.',
        'educational_leadership' => '<strong>Educational Leadership:</strong> As an educator, Gonzalez has played a crucial role in mentoring and shaping the next generation of theologians. Her teaching and guidance have influenced the careers of many scholars, helping them navigate and contribute to the evolving landscape of theology.',
        'promotion_of_social_justice' => '<strong>Promotion of Social Justice:</strong> Her work extends beyond academic research to actively engage with social justice issues. Gonzalez has used her platform to advocate for marginalized communities and address systemic injustices within religious and academic institutions.',
        'collaborative_projects' => '<strong>Collaborative Projects and Conferences:</strong> Gonzalez has participated in and organized various academic conferences and collaborative projects that bring together scholars from diverse backgrounds to discuss and develop new theological perspectives. These initiatives have fostered greater dialogue and understanding within the field.',
        'recognition_and_honors' => '<strong>Recognition and Honors:</strong> Her contributions to theology and education have been recognized through various awards and honors. These recognitions reflect her impact on the academic community and her commitment to advancing the study of theology.',
    ),
    'catherine_gonzalez_degrees' => array(
        'bachelor_of_arts' => '<strong>Bachelor of Arts (B.A.):</strong> Earned her undergraduate degree in religious studies from Harvard University.',
        'master_of_divinity' => '<strong>Master of Divinity (M.Div.):</strong> Completed her Master of Divinity at Harvard Divinity School.',
        'doctor_of_philosophy' => '<strong>Doctor of Philosophy (Ph.D.):</strong> Earned her Ph.D. in Theology from Princeton University, with a thesis focused on liberation theology.',
        'honorary_degrees' => '<strong>Honorary Degrees:</strong> Has received several honorary degrees in recognition of her contributions to theology and theological education.',
    ),
    'catherine_gonzalez_honors' => array(
        'prestigious_awards' => '<strong>Prestigious Awards:</strong> Has been awarded numerous prizes in recognition of her impact in the fields of theology and social justice.',
        'academic_organizations' => '<strong>Member of Academic Organizations:</strong> Has been recognized as an honorary member of several important academic organizations, highlighting her influence in the academic sphere.',
        'public_recognition' => '<strong>Public Recognition:</strong> Her work has been highlighted in various academic publications and media, reflecting her impact and contributions to theology and social justice.',
    ),
