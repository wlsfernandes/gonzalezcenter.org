...
Together, they have a daughter, two granddaughters, and three great-grandchildren.',
    ...
    'youtube_description2' => 'We are also fortunate and deeply thankful that a group of individuals have committed themselves to curating a collection of videos on a YouTube channel dedicated to the many recordings of the Gonzálezes (@drjustogonzalez).',
...
your personal faith journey.',
        ...
        'p6' => 'Access to these wonderful resources held in our collection is by subscription, which can be purchased by going to AETH or by becoming a <i>Friend of the Center</i> (see below). Scroll further down and you will find an example of one of the already-uploaded documents in our collection.',
        'p7' => 'This Bible study, published in <i>El Discípulo</i>, is one of a series of thirteen that spans an entire quarter of Sundays. We have several such series already uploaded and available to those who have access to the collection and we will continue to upload more in the future.',
    ...
    'friends_desc' => array(
        'p1' => 'If you wish to be more involved with the valuable work happening at the Justo and Catherine González Resource Center, consider joining the <i>Friends of the Center</i>. Our <i>Friends</i> are vital collaborators in maintaining and enhancing our resources and programs. This partnership is invaluable to our work and helps ensure that the resources of the Center can continue to be accessible as widely as possible. ',
        'p2' => 'The <i>Friends of the Center</i> are individuals who support the work and vision of the Center both financially and with their feedback, suggestions, and input. ',
        'p3' => '<b>Input and suggestions.</b> As a member of this group, your input and suggestions are not only welcomed but sought.  In order to make your feedback meaningful, you will receive periodic updates on the activities of the Center as well as be given access to the Center’s digital collection, which is usually available only through subscription, for as long as you remain a Friend. As you read of what we are doing or peruse the digital collections, our hope is that you will let us know ways in which you think we might improve, what resources we should offer, and bring to our attention mistakes that should be corrected. (To learn more about the digital collection, <a href="%s">click here</a>.)',
        'p4' => '<b>Communication.</b> As part of the <i>Friends</i>’ program, we will also send you monthly pieces for reflection. These short essays are written by people who, like you, are on a faith journey, have worked or are still working in some form of ministry and who call us to think more deeply about various aspects of faith. Some essays will relate to the Christian calendar; in ordinary time, the reflections often focus on how and where we can most closely experience God. Occasionally we call on the words of those who have gone before us, such as Isidore of Seville, to read words and thoughts that have inspired many over the years.',
        'p5' => '<b>Financial support.</b> Individuals who make an annual donation of $200.00 or more to the Center will automatically have a year-long subscription to the <i>Friends</i> program. Those who make recurring monthly donations of $15.00 or more will be a Friend for as long as the contribution continues. If you wish to become a <i>Friend of the Center</i>, please contact Luz Ortiz by email at lzortiz@aeth.org or by phone at 407-773-1234.',
        'p6' => 'Your support will help us maintain and expand our collection and allow us to offer more valuable materials for research and education. So consider making a lasting impact by joining the <i>Friends of the Center</i> program. You play a vital role in preserving and promoting the legacy of Justo and Catherine González, ensuring that future generations can continue to access and learn from these invaluable resources.',
    ),
    'acervo_desc' => array(
        ...
        'p4' => 'Access to the website is available only to those who subscribe to the Justo and Catherine González Resource Center or are <i>Friends of the Center</i>. To purchase a subscription, please <a href="https://aeth.info/shop/justo-catherine-gonzalez-resource-center-access" target="_blank">click here</a>. To find out information about becoming a <i>Friend of the Center</i> and helping us ensure worldwide access to Gonzáleze’s work, please  <a href="%s">click here</a>.',
        'p44' => 'Access to the website is available only to those who subscribe to the Justo and Catherine González Resource Center or are <i>Friends of the Center</i>. To purchase a subscription, please click below.',
        'p45' => 'To find out information about becoming a <i>Friend of the Center</i> and helping us ensure worldwide access to Gonzáleze’s work, please click below',
        'p5' => ' Below, however, are two examples of documents available through our digital collection. It should give you a taste of what you might find were you to become a <i>Friend of the Center</i> or a subscriber.',
    ...
    'about_desc' => array(
        ...
        'p4' => 'AETH now functions as a virtual organization, with its staff working remotely. The only portion of the organization that requires a physical space is the Center, with all its books, awards, plaques, and honorary doctoral hoods given to the Gonzalezes. The Cooperative Baptist Fellowship offered space in its headquarters in Atlanta, Georgia. Since 2021, the Center’s space at CBF has functioned, as Dr. Jessica Lugo, the Executive Director of AETH, says, “the physical footprint of AETH.”',
        'p5' => 'With the wonderful space offered by CBF, the Center has been able to focus on its core mission with its goals and vision clearly defined.',
        'p6' => 'To find out more about AETH and its many offerings, please <a href="https://aeth.info/en" target="blank" >click here</a> to be redirected'
    ),
    'download_here' => 'Download Here!',
    'our_team22' => 'Meet Our Team',
    'gonzalez_collection' => 'Collections',
    'gotocollection' => 'Click here to access our Collection',
    'gonzalez_video_co' => 'González Video Collection',
    'our_history' => 'Our History',
    'dr' => 'Dr.',
    'contact_desc' => 'Our team is here to help you with any questions or concerns. Whether you need support, have feedback, or just want to learn more about our services, do not hesitate to reach out. We are committed to providing the best service and support possible',
    'your_name' => 'Name',
    'your_email' => 'Email',
    'your_phone' => 'Phone',
    'your_message' => 'Message',
    'send_message' => 'Send Message',
    'purchase_subscription' => 'Purchase a subscription',
