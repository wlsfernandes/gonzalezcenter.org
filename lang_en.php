...
your personal faith journey.',
    ...
    'sophia' => array(
        'p1' => 'Sophia Porter',
        'p2' => '<p>Sophia Porter serves as an intern at the Justo and Catherine González Resource Center, where she works with the Amigo/as del Centro (<i>Friends</> of the Center) program. She is a current Master of Divinity student at Candler School of Theology and lives in Atlanta, Georgia.</p><p> She was born and raised in Marion, Indiana, where she also did her undergraduate. She graduated from Indiana Wesleyan University with majors in Community Development and Pastoral Ministries.</p><p>After undergrad, she studied Spanish linguistics and history at the Universidad de Nebrija in Madrid, Spain. <p>Apart from the time with her studies, she loves spending time with her close family and <i>Friends</>. She has thoroughly enjoyed her time at the Center and looks forward to continuing the work being done.</p>'
    ),
    'jessica' => array(
        'p1' => 'Dr. Jessica Lugo',
    ...
    'friends_desc' => array(
        'p1' => 'If you wish to be more involved with the valuable work happening at the Justo and Catherine González Resource Center, consider joining the <i>Friends</> of the Center. Our <i>Friends</> are vital collaborators in maintaining and enhancing our resources and programs. This partnership is invaluable to our work and helps ensure that the resources of the Center can continue to be accessible as widely as possible.. ',
        'p2' => 'The <i>Friends</> of the Center are individuals who support the work and vision of the Center both financially and with their feedback, suggestions, and input. ',
        ...
        'p4' => '<b>Communication.</b> As part of the <i>Friends</>’ program, we will also send you monthly pieces for reflection. These short essays are written by people who, like you, are on a faith journey, have worked or are still working in some form of ministry and who call us to think more deeply about various aspects of faith. Some essays will relate to the Christian calendar; in ordinary time, the reflections often focus on how and where we can most closely experience God. Occasionally we call on the words of those who have gone before us, such as Isidore of Seville, to read words and thoughts that have inspired many over the years.',
        'p5' => '<b>Financial support.</b> Individuals who make an annual donation of $200.00 or more to the Center will automatically have a year-long subscription to the <i>Friends</>` program. Those who make recurring monthly donations of $15.00 or more will be a Friend for as long as the contribution continues. If you wish to become a Friend of the Center,  please contact Luz Ortiz by email at lzortiz@aeth.org or by phone at 407-773-1234.',
    ...
    'acervo_desc' => array(
        ...
        'p4' => 'Access to the website is available only to those who subscribe to the Justo and Catherine González Resource Center or are <i>Friends</> of the Center. To purchase a subscription, please <a href="https://aeth.info/en/afiliacion" target="_blank">click here</a>. To find out information about becoming a Friend of the Center and helping us ensure worldwide access to Dr. González’s work, please <a href="friend.php" target="_blank">click here</a>.',
